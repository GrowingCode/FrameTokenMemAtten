...
class TreeDecodeModel(BasicDecodeModel):
  ...
  def __call__(self, one_example, training = True):
    ...
    self.pre_post_order_node_type_content_en_tensor, self.pre_post_order_node_state_tensor, self.pre_post_order_node_post_order_index_tensor = one_example[4], one_example[5], one_example[6]
